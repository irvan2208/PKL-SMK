...
<div class="wrapper">
  ...
  <div id="topbar">
    ...
    <div id="search">
      <form action="c_t_beli_cash.php" method="get">
        <fieldset>
          <legend>Site Search</legend>
          <input type="text" name="cari" value="Cari Kode cash / No. ktp&hellip;"  onfocus="this.value=(this.value=='Cari Kode cash / No. ktp&hellip;')? '' : this.value ;" />
...
<table width="700" border="1">
  <tr bgcolor="#3b5998" height="15px" style="font-family:Arial, Helvetica, sans-serif; color:white; font-size:12px; font-weight:700" align="center">
    <td width="14%">KODE CASH</td>
    <td width="20%">NO KTP PEMBELI</td>
    <td width="17%">KODE MOTOR</td>
    <td width="19%">TANGGAL CASH</td>
    <td width="15%">BAYAR CASH</td>
    <td width="15%">PILIHAN</td>
  </tr>
  <div hidden="enable">
  <?php
	$id = $_GET['cari'];
  ...
  <?php
  include("koneksi.php");
  $query = mysql_query("select * from beli_cash where cash_kode = '$id' or pembeli_no_ktp = '$id'");
  while($d = mysql_fetch_array($query)){ ?>
  <tr>
    <td><?php echo $d['cash_kode']; ?></td>
    <td><?php echo $d['pembeli_no_ktp']; ?></td>
    <td><?php echo $d['motor_kode']; ?></td>
    <td><?php echo $d['cash_tanggal']; ?></td>
    <td><?php echo $d['cash_bayar']; ?></td>
    <td><a href="e_beli_cash.php?id=<?php echo $d['cash_kode'];?>">edit</a>|<a href="h_beli_cash.php?id=<?php echo $d['cash_kode']; ?>" onClick="return confirm('anda yakin ingin menghapus ?');">delete</a></td>
  </tr>
  <?php } ?>
</table>
    <br class="clear" />

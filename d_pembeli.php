    ...
    <div class="container" align="center">
      ...
      <tr style="font-size:15px; font-family:Arial, Helvetica, sans-serif; font-weight:500;">
        <td><table width="100%" border="1">
          ...
          <?php
		  include("koneksi.php");
		  $query = mysql_query("select pembeli.pembeli_no_ktp, pembeli.pembeli_nama, motor.motor_merk, motor.motor_type, motor.motor_warna_pilihan, beli_cash.cash_bayar, beli_cash.cash_tanggal from pembeli, beli_cash, motor where pembeli.pembeli_no_ktp = beli_cash.pembeli_no_ktp and beli_cash.motor_kode = motor.motor_kode");

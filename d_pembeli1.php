    ...
    <div class="container" align="center">
      ...
      <tr style="font-size:15px; font-family:Arial, Helvetica, sans-serif; font-weight:500;">
        <td><table width="100%" border="1">
            <tr bgcolor="#3b5998" height="15px" style="font-family:Arial, Helvetica, sans-serif; color:white; font-size:13x; font-weight:700" align="center">
          ...
          <?php
		  include("koneksi.php");
		  $query = mysql_query("select pembeli.pembeli_no_ktp, pembeli.pembeli_nama, motor.motor_merk, motor.motor_type, motor.motor_warna_pilihan, beli_kridit.paket_kode, beli_kridit.kridit_tanggal, bayar_cicilan.cicilan_sisa_ke, bayar_cicilan.kridit_kode from pembeli, beli_kridit, motor, bayar_cicilan where pembeli.pembeli_no_ktp = beli_kridit.pembeli_no_ktp and beli_kridit.motor_kode = motor.motor_kode and beli_kridit.kridit_kode = bayar_cicilan.kridit_kode");
          ...
          <tr style="font-size:15px; font-family:Arial, Helvetica, sans-serif; font-weight:500;">
            ...
            <td><?php echo $d['cicilan_sisa_ke']; ?></td>
          </tr>
          <?php } ?>
      </table></td>
      </tr>

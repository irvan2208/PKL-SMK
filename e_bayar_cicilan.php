...
<title>UPDATE BAYAR CICILAN</title>
...
include ("koneksi.php");
$id = $_GET['id'];
$query = mysql_query("select * from bayar_cicilan where cicilan_kode= '$id'");
$data = mysql_fetch_array($query);
?>
<form action="sc_e_bayar_cicilan.php" method="post">
<table width="500" border="1">
<tr>
  <td colspan="2" height="20" valign="middle" bgcolor="#3b5998" style=" font-family:Arial, Helvetica, sans-serif; color:white; font-size:20px;">UPDATE DATA BAYAR CICILAN</td>
  </tr>
  <tr>
    <td width="77%">KODE CICILAN</td>
    <td width="23%"><input name="kd" type="text" value="<?php echo $data['cicilan_kode'];?>" disabled="disabled" size="28"/>
    <input type="hidden" name="kd" value="<?php echo $data['cicilan_kode'];?>" /></td>
  </tr>
  <tr>
    <td>KODE KRIDIT</td>
    <td><select name="kk">
  ...
  <tr>
    ...
    <td><input name="tgl" type="date" value="<?php echo $data['cicilan_tanggal'];?>" /></td>
  </tr>
  <tr>
    <td>JUMLAH CICILAN</td>
    <td><input name="jc" type="text" value="<?php echo $data['cicilan_jumlah'];?>" size="28"/></td>
  </tr>
  <tr>
    <td>CICILAN KE</td>
    <td><input name="ck" type="text"  value="<?php echo $data['cicilan_ke'];?>" size="28"/></td>
  </tr>
  <tr>
    <td>CICILAN SISA KE</td>
    <td><input name="csk" type="text" value="<?php echo $data['cicilan_sisa_ke'];?>" size="28" /></td>
  </tr>
  <tr>
    <td>CICILAN SISA HARGA</td>
    <td><input name="csh" type="text" value="<?php echo $data['cicilan_sisa_harga'];?>" size="28"/></td>
  </tr>
  <tr>

...
<ul>
      ...
      <li class="last"><a href="view.php">ARTIKEL</a></li>
    </ul>
    <br class="clear" />
</div>
</div>
...
?>
<form method="post" action="sc_e_motor.php" enctype="multipart/form-data">
...
<tr>
  ...
  <tr>
    <td width="68%">KODE MOTOR</td>
    <td width="32%"><input name="kd" type="text" value="<?php echo $data['motor_kode'];?>" disabled="disabled"/>
    <input type="hidden" name="kd" value="<?php echo $data['motor_kode'];?>" /></td>
  </tr>
  <tr>
    <td>MERK MOTOR</td>
    <td><input type="text" name="mr" value="<?php echo $data['motor_merk'];?>"/></td>
  </tr>
  <tr>
    <td>TIPE MOTOR</td>
    <td><input type="text" name="tp" value="<?php echo $data['motor_type'];?>"/></td>
  </tr>
  <tr>
    <td>WARNA MOTOR</td>
    <td><input type="text" name="wr" value="<?php echo $data['motor_warna_pilihan'];?>"/></td>
  </tr>
  <tr>
    <td>HARGA MOTOR</td>
    <td><input type="text" name="hr" value="<?php echo $data['motor_harga'];?>"/></td>
  </tr>
  <tr>
    <td>GAMBAR MOTOR</td>
    <td align="center"><p><img src="upload/<?php echo $data['motor_gambar']; ?>"
  width="50px" height="50px"/></p>
      <p><input type="file" name="gambar1" value="upload/<?php echo $data['motor_gambar']; ?>"/></p></td>
  </tr>
  <tr>
    <td>DESKRIPSI</td>
    <td><textarea name="desk" cols="50" rows="10"><?php echo $data['desk']; ?></textarea></td>
  </tr>
  <tr>

...
<form action="sc_m_motor.php" method="post" enctype="multipart/form-data">
<table width="500" border="7" align="center" id="as">
  <tr>
  <td colspan="2" height="20" valign="middle" bgcolor="#3b5998" style=" font-family:Arial, Helvetica, sans-serif; color:white; font-size:20px;">TAMBAH DATA MOTOR</td>
  </tr>
  <tr>
    <td width="68%">KODE MOTOR</td>
    <td width="32%"><input type="text" name="kd" size="30"/></td>
  </tr>
  <tr>
    <td>MERK MOTOR</td>
    <td><input type="text" name="mr" size="30"/></td>
  </tr>
  <tr>
    <td>TIPE MOTOR</td>
    <td><input type="text" name="tp" size="30"/></td>
  </tr>
  <tr>
    <td>WARNA MOTOR</td>
    <td><input type="text" name="wr" size="30"/></td>
  </tr>
  <tr>
    <td>HARGA MOTOR</td>
    <td><input type="text" name="hr" size="30" onkeypress="return goodchars(event,'0123456789',this)"/></td>
  </tr>
  <tr>
    <td>GAMBAR MOTOR</td>
  ...
  <tr>
    <td>DESKRIPSI</td>
    <td><textarea name="desk" cols="28" rows="7"></textarea></td>
  </tr>
  <tr>

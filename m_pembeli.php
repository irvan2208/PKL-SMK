...
<form action="m_pembeli1.php" method="post">
<table width="500" border="7" align="center" id="as">
  <tr>
  <td colspan="2" height="20" valign="middle" bgcolor="#3b5998" style=" font-family:Arial, Helvetica, sans-serif; color:white; font-size:20px;">TAMBAH DATA PEMBELI</td>
  </tr>
  <tr>
    <td width="80%">NO KTP</td>
    <td width="20%"><input type="text" name="nk" maxlength="16" onkeypress="return goodchars(event,'0123456789',this)"/></td>
  </tr>
  <tr>
    <td>NAMA</td>
  ...
  <tr>
    <td>NO TELPON</td>
    <td><input type="text" name="nt" maxlength="15" onkeypress="return goodchars(event,'0123456789',this)"/></td>
  </tr>
  <tr>
    <td>NO HP</td>
    <td><input type="text" name="nh" maxlength="15" onkeypress="return goodchars(event,'0123456789',this)"/></td>
  </tr>
  <tr>
    <td>PILIH METODE PEMBAYARAN</td>
    <td align="center"><select name="mp" id="mp">

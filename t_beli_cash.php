    ...
    <div id="search">
      <form action="c_t_beli_cash.php" method="get">
        <fieldset>
          ...
          <input type="text" name="cari" value="Masukkan Kode cash&hellip;"  onfocus="this.value=(this.value=='Masukkan Kode cash&hellip;')? '' : this.value ;" />
...
<table width="700" border="1">
  ...
  <tr>
    ...
    <td><a href="e_beli_cash.php?id=<?php echo $d['cash_kode'];?>">edit</a>|<a href="h_beli_cash.php?id=<?php echo $d['cash_kode']; ?>" onClick="return confirm('anda yakin ingin menghapus data dengan kode "<?php echo $d['cash_kode']; ?>" ?');">delete</a></td>
  </tr>
  <?php } ?>
</table>
    <br class="clear" />

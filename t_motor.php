...
<div class="wrapper">
  ...
  <div id="topbar">
    ...
    <div id="search">
      <form action="c_t_motor.php" method="get">
        <fieldset>
          <legend>Site Search</legend>
          <input type="text" name="cari" value="Masukkan kode motor&hellip;"  onfocus="this.value=(this.value=='Masukkan kode motor&hellip;')? '' : this.value ;" />
...
<table width="700" border="1">
  ...
  <tr>
    ...
    <td><?php echo $d['motor_merk']; ?></td>
    <td><?php echo $d['motor_type']; ?></td>
    <td><?php echo $d['motor_warna_pilihan']; ?></td>
    <td><?php echo $d['motor_harga']; ?></td>
    <td><img src="upload/<?php echo $d['motor_gambar']; ?>"
  width="80px" height="80px"/></td>
  <td><?php $kata= $d['desk']; echo substr($kata,0,120); ?>...</td>
    <td><a href="e_motor.php?id=<?php echo $d['motor_kode'];?>">edit</a>|<a href="h_motor.php?id=<?php echo $d['motor_kode']; ?>" onClick="return confirm('anda yakin ingin menghapus ?');">delete</a></td>
  </tr>
  <?php } ?>
</table>
    <br class="clear" />

...
<div class="wrapper">
  ...
  <tr style="font-size:15px; font-family:Arial, Helvetica, sans-serif; font-weight:900;">
    <td><a href="artikel.php?id=<?php echo $d['motor_kode']; ?>"><?php echo $d['motor_merk']; ?> <?php echo $d['motor_type']; ?></a></td>
    <td style=" color:#666666;">Rp. <?php echo $d['motor_harga']; ?>,00</td>
  </tr>
  <?php } ?>
</table>
        </li>
